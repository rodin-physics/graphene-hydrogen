...
DFT_Bands_S = readdlm("Data/DFT/bands/buckled/uc.B-C-s.bands")
DFT_Bands_PX = readdlm("Data/DFT/bands/buckled/uc.B-C-px.bands")
DFT_Bands_PY = readdlm("Data/DFT/bands/buckled/uc.B-C-py.bands")
DFT_Bands_PZ = readdlm("Data/DFT/bands/buckled/uc.B-C-pz.bands")
...
savefig("UC_Projection_Buckled.pdf")
